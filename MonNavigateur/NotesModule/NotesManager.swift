...
public class NotesManager: ObservableObject {
    ...
    private func ajouterNoteBase(note: NoteBlock, completion: ((Bool) -> Void)? = nil) {
        ...
        let donnees: [String: Any] = ["id": note.id!.uuidString, "content": note.content, "order_index": note.order_index, "is_pinned": note.is_pinned, "is_favorite": note.is_favorite, "category": note.category, "user_id": Config.userId]
